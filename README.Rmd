...
For the ensemble models, we will fit the three different models(bagged trees, random forests, or boosted trees) and choose the best one after comparing the misclassification rate.
